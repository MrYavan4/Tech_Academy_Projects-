...
class Feedback:
    ...
    def __init__(self, master):
        ...
        self.logo = PhotoImage(file = 'C:\\Users\\tanvir\\Desktop\\Ex_Files_Python_Tkinter\\Exercise Files\\Ch08\\tour_logo.gif')
        ...
        ttk.Label(self.frame_header, wraplength = 300,
                  text = ("We are glad you chose, Explore California for your recent adventure. "
                          "Please tell us what you thought of the recent Desert to Sea tour.")).grid(row = 1, column = 1)
